/*
Command network-api is the JN trust network courts API binary.
...
import (
	...
	"github.com/baseproof/trust-network-courts/api"
	"github.com/baseproof/trust-network-courts/api/config"
	"github.com/baseproof/trust-network-courts/api/exchange"
	authv2 "github.com/baseproof/trust-network-courts/api/exchange/auth/v2"
	"github.com/baseproof/trust-network-courts/api/exchange/handlers"
	"github.com/baseproof/trust-network-courts/api/exchange/index"
	"github.com/baseproof/trust-network-courts/api/judicial"
	"github.com/baseproof/trust-network-courts/api/verification"
