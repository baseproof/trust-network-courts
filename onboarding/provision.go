...
KEY DEPENDENCIES:
  ...
  - trust-network-courts/schemas: schema registry for resolving URIs
  - trust-network-courts/topology: SpokeConfig (court + three log DIDs)
*/
package onboarding
