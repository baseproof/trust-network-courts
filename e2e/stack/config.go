...
import (
	...
	"github.com/baseproof/trust-network-courts/e2e/topology"
)
...
// JN's own images stay under ghcr.io/baseproof/trust-network-courts, and
...
const (
	...
	ghcr    = "ghcr.io/baseproof"         // JN's own image namespace (unchanged)
...
func ResolveImages() Images {
	...
	return Images{
		...
		Aggregator: env("E2E_AGGREGATOR_IMAGE", ghcr+"/trust-network-courts/aggregator:latest"),
		JN:         env("E2E_JN_IMAGE", ghcr+"/trust-network-courts:latest"),
	}
}
