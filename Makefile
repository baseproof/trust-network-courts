# Trust Network Courts — make targets
#
# Versioning:
...
version: ## Print trust-network-courts version + dep pins
	@echo "trust-network-courts    $(JN_VERSION)"
...
# baseproof/ledger at v1.2.0). trust-network-courts does NOT
# ship a witness binary; deployments consume the standalone-witness
# module directly:
#     go install github.com/baseproof/standalone-witness@<ver>
...
# the SDK that trust-network-courts depends on. Every muEnable constant
