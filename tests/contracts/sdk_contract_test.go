...
DESCRIPTION:
	...
	Contract validation tests pinning trust-network-courts's assumptions
	about the SDK at v0.7.75. Per the architecture spec ("If any file
	in trust-network-courts/ reimplements a pattern below, the SDK is
...
import (
	...
	"github.com/baseproof/baseproof/crypto/sct"
