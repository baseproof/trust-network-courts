...
|---|---|---|
| Ledger admission | `baseproof/ledger` | Already on the admission-refactor track (issue #75 decisions 9 + 10) |
| JN historical verification | `baseproof/trust-network-courts` | New work — issue to file. |
| JN real-time gate | `baseproof/trust-network-courts` | New work — issue to file. |
| JN cross-network recognition | `baseproof/trust-network-courts` | Future work — issue for roadmap visibility. |
...
- `baseproof/ledger` issue #75 — admission-refactor decisions, including ledger-side resolver implementation
