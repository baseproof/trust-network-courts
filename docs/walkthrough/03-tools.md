...
| `court-tools` | `:8090` | trust-network-courts (host) |
| `provider-tools` | `:8091` | trust-network-courts (host) |

Plus your gcloud ADC pointing at two real GCS buckets.

This is the **whole trust-network-courts app running on your laptop**
